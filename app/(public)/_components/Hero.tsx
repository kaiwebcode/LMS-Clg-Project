  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-[-10%] h-[400px] w-[400px] -translate-x-1/2 rounded-full bg-primary/40 blur-[120px]" />
        <div className="absolute right-0 bottom-0 h-[300px] w-[300px] rounded-full bg-purple-500/40 blur-[120px]" />
        <div className="absolute left-0 bottom-0 h-[300px] w-[300px] rounded-full bg-blue-500/40 blur-[120px]" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="flex flex-col justify-center animate-fade-up">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              LearnSphere is the all-in-one learning management system that helps
              students, educators, and teams master new skills with interactive
              courses, live classes, and intelligent progress tracking.
            </p>
          ...
          <div className="relative flex justify-center animate-fade-up [animation-delay:200ms]">
            ...
            <Image
              ...
              className="w-full max-w-[520px] rounded-3xl shadow-3xl hover:scale-[1.02] transition duration-300"
            />
          </div>
        </div>
      </div>
